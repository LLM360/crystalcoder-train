...
def _add_network_size_args(parser):
    ...
    group.add_argument('--rotary-interleave-repeat', action='store_true', 
                       help='Use this option to repeat the frequency in an interleaved way. '
                       'Otherwise it will not be interleaved. '
                       'This affects the order of the cos and sin in the rotary dimension.' )
    group.add_argument('--rotary-stay-fp32', action='store_true', 
                       help='Use this option to keep the rotary embeddings in fp32. ')
...
def _add_mup_args(parser):
    ...
    group.add_argument('--use-mup', action='store_true', help='Use muP.')
    group.add_argument('--mup-width-scale', type=float, default=1.0)
    group.add_argument('--mup-output-alpha', type=float, default=1.0)
    group.add_argument('--mup-scale-qk-dot-by-d', action='store_true')
    group.add_argument('--mup-embeddings-scale', type=float, default=1.0)
