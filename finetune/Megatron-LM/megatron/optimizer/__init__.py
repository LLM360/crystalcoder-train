...
def get_param_groups(modules,
    ...
    no_wd_no_scale_lr = []
    no_wd_scale_lr = []
    wd_no_scale_lr_names = [] 
    wd_scale_lr_names = []
    no_wd_no_scale_lr_names = []
    no_wd_scale_lr_names = []
    ...
    print_rank_0('param groups:')
    print_rank_0('No weight decay, no scale lr:')
    print_rank_0('\n'.join(no_wd_no_scale_lr_names))
    print_rank_0('No weight decay, scale lr:')
    print_rank_0('\n'.join(no_wd_scale_lr_names))
    print_rank_0('Weight decay, no scale lr:')
    print_rank_0('\n'.join(wd_no_scale_lr_names))
    print_rank_0('Weight decay, scale lr:')
    print_rank_0('\n'.join(wd_scale_lr_names))
